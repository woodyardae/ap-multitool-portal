...
<body>
    <div class="container">
        ...
        <div class="dls">
            <a href="https://github.com/woodyardae/ap-multitool/releases/download/v1.0.0-beta1/APMultitool_Setup_v1.0.0-beta1.exe" class="dl-card" style="border: 2px solid var(--accent); background: rgba(40, 143, 79, 0.01);">
                <span class="ico">🪟</span>
                <h4>Windows Setup</h4>
